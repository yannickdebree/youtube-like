export const EMAIL_FORMAT_ERROR =
    "Email is missing or don't have an email format"
export const PASSWORD_FORMAT_ERROR =
    "Password is missing or don't have more than 8 characters"
...
export const EMPTY_VIDEO_SOURCE = 'Video source is needed'
